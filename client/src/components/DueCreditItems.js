...
const DueCreditsWithItems = () => {
  ...
  return(
  <Layout>
  <h2 className="ml-3 mt-2">Due Credits with items Component</h2>
  <div >
...
export default DueCreditsWithItems;
...
//   return(
//   <Layout>
//   <h1>Due Credits With Items Component</h1>
//   <div >
...
//   </div>
//   {!bills.length ? (
//     <li>Congratulations there are no due credits with items.</li>
//   ) : (
